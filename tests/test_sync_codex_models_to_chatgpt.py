    ...
    return CodexCatalog(
        models=(
            ...
            CodexModel(
                ...
                context_window=272000,
                input_modalities=("text", "image"),
                supported_reasoning_levels=_reasoning_levels("low", "medium", "high", "xhigh"),
                supports_parallel_tool_calls=True,
                supports_search_tool=True,
            ),
            CodexModel(
...
def test_sync_model_costs_uses_catalog_models_and_preserves_image_sync():
    ...
    assert result.model_costs["chatgpt/codex-auto-review"]["input_cost_per_token"] == 0.0000025
...
def test_replace_with_default_preserve_keeps_manual_chatgpt_entries():
    model_costs = parse_model_costs(
        """
        {
            "gpt-5.6-sol": {
...
def test_replace_generates_missing_default_preserve_entries():
    model_costs = parse_model_costs(
        """
        {
            "gpt-5.6-sol": {
