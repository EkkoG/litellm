    ...
    **kwargs,
    ...
    try:
        ...
        litellm_params = get_litellm_params(
            ...
            xai_oauth_refresh_token=kwargs.get("xai_oauth_refresh_token"),
            xai_oauth_expires_at=kwargs.get("xai_oauth_expires_at"),
            xai_oauth_token_endpoint=kwargs.get("xai_oauth_token_endpoint"),
            managed_credential_name=kwargs.get("managed_credential_name"),
            managed_credential_provider=kwargs.get("managed_credential_provider"),
            managed_credential_auth_type=kwargs.get("managed_credential_auth_type"),
