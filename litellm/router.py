...
class Router:
    ...
    def _update_deployment_indices_after_removal(self, model_id: str, removal_idx: int) -> None:
        ...
        self._remove_deployment_from_team_pattern_routers(model_id=model_id)

    def _remove_deployment_from_team_pattern_routers(self, model_id: str) -> None:
        for team_id, team_pattern_router in tuple(self.team_pattern_routers.items()):
